...
public:
    ...
    void setupUi(QMainWindow *RegistroStock)
    {
        if (RegistroStock->objectName().isEmpty())
            RegistroStock->setObjectName(QString::fromUtf8("RegistroStock"));
        ...
        btn_ActualizarPrecio->setObjectName(QString::fromUtf8("btn_ActualizarPrecio"));
        ...
        input_Cantidad->setObjectName(QString::fromUtf8("input_Cantidad"));
        ...
        btn_ActualizarStock->setObjectName(QString::fromUtf8("btn_ActualizarStock"));
        ...
        btn_GenerarPDF_Stock->setObjectName(QString::fromUtf8("btn_GenerarPDF_Stock"));

        verticalLayout_3->addWidget(btn_GenerarPDF_Stock);

        btn_imprimirStock = new QPushButton(groupBox_2);
        btn_imprimirStock->setObjectName(QString::fromUtf8("btn_imprimirStock"));
        ...
        table_Stock->setObjectName(QString::fromUtf8("table_Stock"));
